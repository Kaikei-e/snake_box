...
def create_container_root(image_name, image_dir, container_id, container_dir):
    ...
    container_root = _get_container_path(container_id, container_dir, 'roofs')
...
@cli.option('-i', '--image-name', help='Image name', default='ubuntu')
@cli.option('--image-dir', help='Image directory', default='/workshop/images')
